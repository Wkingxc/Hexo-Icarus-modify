                ...
                <article class={`card-content article${'direction' in page ? ' ' + page.direction : ''}`} role="article">
                    ...
                    {page.layout !== 'page' ? <div class="article-meta is-size-7 is-uppercase level is-mobile">
                        <div class="level-left">
                            ...
                            {index && page.good_article ? (
                            <span className="tag is-success is-light">精选</span>
                            ) : null}

                            {index && page.top ? (
                            <span className="tag is-danger is-light">置顶</span>
                            ) : null}

                            {index && page.copy_from ? (
                                <span class="tag is-warning is-light">转载</span>
                            ) : null}
                            ...
                            {page.categories && page.categories.length ? <span class="level-item">
                                {(() => {
                                    ...
                                    page.categories.forEach((category, i) => {
                                        categories.push(<a class="link-muted" style="color:#1E90FF;" href={url_for(category.path)}>{category.name}</a>);
